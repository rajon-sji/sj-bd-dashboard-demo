...
import TriageCopilotPage from "./pages/bd/TriageCopilot";
...
// Demo entry — open BD Triage Copilot without auth
function DashboardRedirect() {
  return <Navigate to="/bd/triage" replace />;
}
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            {/* BD Triage Copilot — public demo route */}
            <Route path="/bd/triage" element={<DemoLayout />}>
              <Route index element={<TriageCopilotPage />} />
            </Route>
